...
public class SearchActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Book>>, AdapterView.OnItemSelectedListener {
    ...
    public void onLoadFinished(Loader<List<Book>> loader, List<Book> data) {
        ...
        if (data.size() > 0) {
            ...
            BookAdapter adapterForSearchResults = new BookAdapter(this, 0, data);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            BookAdapter adapter = new BookAdapter(this, 0, booksArrayList);
